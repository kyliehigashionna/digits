      ...
      <div className='digits-landing-background'>
        <Grid container centered stackable columns={3}>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header inverted as='h3'>This address book enables any number of users to register and save
            this business contacts, You can only see the contacts you created</Header>
          </Grid.Column>
          ...
          <Grid.Column textAlign='center' >
            ...
            <Header inverted as='h3'>Each time you make contact with a contact, you can write a note that
